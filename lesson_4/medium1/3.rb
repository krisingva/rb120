...
# Answer: You would also be creating a writer method for product_name which may
# not be intentional
...
shopping_bag = InvoiceEntry.new('apples', 5)
p shopping_bag
shopping_bag.quantity = 8
p shopping_bag
shopping_bag.update_quantity(7)
p shopping_bag