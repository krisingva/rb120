...
# Answer:
# 1. Keep methods categorized depending on how they should be used (either in
#    modules or classes)
# 2. Reduce the need to rewrite methods by using inheritance or mixed in modules
# 3. Create custom objects

# LS:
# Because there are so many benefits to using OOP we will just summarize some of
# the major ones:
