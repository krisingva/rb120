# Want to get rid of `@name` variable of `Computer` that points to
# `Computer1/2/3` objects. Now I have `@computer` initialized to
# directly point to a `Computer1/2/3` object.
...
class RPSGame
  ...
  def determine_winner
    if human.move.beats(computer.move.pick)
      "human"
    elsif computer.move.beats(human.move.pick)
      "computer"
    end
  end
