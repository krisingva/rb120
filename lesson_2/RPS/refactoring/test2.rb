...
class RPSGame
  ...
  def determine_winner
    if human.move.value.beats.include?(computer.name.move.value)
      "human"
    elsif computer.name.move.value.beats.include?(human.move.value)
      "computer"
    end
  end
...
class Move
  ...
  def beats?(other_move)
    self.value == 'r' && ['sc', 'l'].include?(other_move.value) ||
      self.value == 'p' && ['sp', 'r'].include?(other_move.value) ||
      self.value == 'l' && ['sp', 'p'].include?(other_move.value) ||
      self.value == 'sp' && ['sc', 'r'].include?(other_move.value)
  end
end
