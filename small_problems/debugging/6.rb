...
# Answer:
# Define a `<=>` method in the class to compare values of two `Length` objects
# and include the `Comparable` module in the class to gain all the other
# comparison methods.
...
# (Length.new(10, :km).as_nautical_miles.as_kilometers - Length.new(10,
# :km)).abs < 0.001 # => true