...
# Now we need both a setter and a getter method for both variables:
class Book
...
# Answer: When you create and initialize at once, it might be easier to validate
# the arguments used for instantiation and only create the object if valid.