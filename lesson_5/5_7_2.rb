...
# Answer:
# Use a `TTTGame` class variable for `@@human_total` and `@@computer_total` and
# update them when there is a winner, make a update_total method, a reset_totals
# method for when the round is done, a total_winner? method that returns a
# winner if one of them has 5 points and change the play method to loop until a
# total_winner? returns true.
